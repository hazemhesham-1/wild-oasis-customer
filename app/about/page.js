  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <p>
            ...
            and peace you will find in the surrounding mountains. Wander
            through lush forests, breathe in the fresh air, and watch
      ...
      <div className="col-span-2">
        <Image
          src={image1}
          alt="Man embracing his wife in hotel, sharing a tender moment."
          placeholder="blur"
          quality={80}
        />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <p>
            ...
            guest, you're part of our extended family. So join us at The Wild Oasis
